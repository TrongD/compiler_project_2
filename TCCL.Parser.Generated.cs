...
{CurrentSemanticValue = new ClassDeclaration(ValueStack[ValueStack.Depth-1]);}
        break;
...
{CurrentSemanticValue = ValueStack[ValueStack.Depth-2].makeSibling(new Modifiers(ModifierType.PUBLIC)); CurrentSemanticValue = ValueStack[ValueStack.Depth-2];}
        break;
      case 18: // Modifiers -> Modifiers, PRIVATE
{CurrentSemanticValue = ValueStack[ValueStack.Depth-2].makeSibling(new Modifiers(ModifierType.PRIVATE)); CurrentSemanticValue = ValueStack[ValueStack.Depth-2];}
        break;
...
{ CurrentSemanticValue = new LocalItems(ValueStack[ValueStack.Depth-2], ValueStack[ValueStack.Depth-1]); }
        break;
      case 48: // LocalItem -> LocalVariableDeclaration
{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
        break;
      case 49: // LocalItem -> Statement
{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1] ;}
        break;
...
{ CurrentSemanticValue = new LocalVariableNames(ValueStack[ValueStack.Depth-3], ValueStack[ValueStack.Depth-1]); }
        break;
      case 55: // Statement -> ExpressionStatement, SEMICOLON
{ CurrentSemanticValue = new Statement(ValueStack[ValueStack.Depth-2]);}
        break;
      case 61: // ExpressionStatement -> Expression
{CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
        break;
...
{ CurrentSemanticValue = new MethodCall(ValueStack[ValueStack.Depth-3]); }
        break;
      case 105: // QualifiedName -> Identifier
{ CurrentSemanticValue = ValueStack[ValueStack.Depth-1]; }
        break;
